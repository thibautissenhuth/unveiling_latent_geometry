...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help='latent space with mixt. distribution')
    parser.add_argument(
        '--simplicial_sampling',
        type=str2bool,
        default=False,
        help='simplicial latent space')
    parser.add_argument(
        '--simplicial_linear',
        type=str2bool,
        default=False,
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Number of modes in simplicial cluster")
    parser.add_argument('--jacobian_truncation',action='store_true',
        help='JBT Truncation')
    parser.add_argument(
        '--simplicial_threshold',
        type=float,
        default=0.1,
        help="Number of modes in simplicial cluster")
    parser.add_argument(
        '--simplicial_classification',
        type=float,
        default=0.,
        help="Number of modes in simplicial cluster")
    parser.add_argument(
        '--simplicial_classification_epoch_end',
        type=float,
        default=100000.,
        help="Number of modes in simplicial cluster")
    parser.add_argument('--init_type', type=str, default='normal',
                        choices=['normal', 'orth', 'xavier_uniform', 'xavier_uniform_scaled', 'false'],
                        help='The init type')
    parser.add_argument('--init_type_linear', type=str, default='normal',
                        choices=['default', 'normal_scaled'],
                        help='The init type')
    ...
    parser.add_argument('--g_norm_resnet', type=str, default="in",
                        help='Generator Normalization')
